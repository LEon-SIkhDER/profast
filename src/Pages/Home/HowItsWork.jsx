                ...
                <div className='max-w-7xl mx-auto'>
                    ...
                    <div className='flex justify-between items-end mb-4 sm:mb-8 flex-wrap md:flex-nowrap gap-4 md:gap-5'>
                        <div className='shrink-0'>
                            <motion.h2
                                ...
                                className='px-4 py-2 bg-[#CAEB66]/40 rounded-full text-sm font-bold text-teal-800 mb-3 inline-block'>Simple parcel flow</motion.h2>
                            <motion.h1
                                initial={{
                                    y: 60,
                                    opacity: 0,
                                ...
                                viewport={{ once: true, amount: .50 }}
                                className='text-4xl font-extrabold text-teal-950'>How It Works</motion.h1>
                        </div>
                        <motion.p
                            initial={{
                                y: 60,
                            ...
                            viewport={{ once: true, amount: .50 }}
                            className=' md:text-right max-w-xl text-gray-600 font-medium'>From booking to final confirmation, Profast keeps each parcel step clear, trackable, and easy to manage.</motion.p>
                    </div>
                    ...
                    <div className='grid lg:grid-cols-3 gap-5'>
                        <motion.div
                            ...
                            className=' p-7 secondary-bg rounded-4xl space-y-4 text-white relative overflow-hidden '>
