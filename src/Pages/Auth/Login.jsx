...
const Login = () => {
    const { handleSignInWithEmailAndPassword, logInWithGooglePopUp, logOut, theme } = useContext(AuthContext)
    ...
    return (
        <div className='  '> {/** i wanna make this div vertically center */}
            ...
            <form onSubmit={handleLogIn} className='space-y-2'>
                ...
                <a href='/forget-pass' className='underline text-gray-700 dark:text-[#CBD5D1] text-sm mb-2 block '>Forget Password</a>
                {errorMessage && (
            ...
            <button onClick={handleGoogleLogIn} className="btn btn-block text-base bg-white dark:bg-[#071A1D] text-black dark:text-[#F5F7F2] border-[#e5e5e5]">
